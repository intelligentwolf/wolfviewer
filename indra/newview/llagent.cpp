...
void LLAgent::propagate(const F32 dt)
{
    ...
    if (floater_move)
    {
        ...
        // <WolfViewer 2026-09-25> the Joysticks tab's fly up / down pair (llmoveview.cpp)
        floater_move->mStickUpButton   ->setToggleState( gAgentCamera.getUpKey() > 0 );
        floater_move->mStickDownButton ->setToggleState( gAgentCamera.getUpKey() < 0 );
        // </WolfViewer>
    }
